...
export const UploadIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3 17.25V21h18v-3.75M3.75 13.5h16.5" />
  </svg>
);
...
export const PDFIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.75 12V9A1.5 1.5 0 007.5 7.5h-1.5a1.5 1.5 0 00-1.5 1.5v7.5m1.5-4.5h.75a.75.75 0 01.75.75v3a.75.75 0 01-.75.75h-.75m-1.5-4.5H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
    </svg>
);

export const FileTypeIcon: React.FC<{ fileType: string, className?: string }> = ({ fileType, className }) => {
...
export const SunIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-6.364-.386l1.591-1.591M3 12h2.25m.386-6.364l1.591 1.591M12 12a2.25 2.25 0 00-2.25 2.25 2.25 2.25 0 002.25 2.25c.69 0 1.323-.285 1.767-.733S14.25 12.69 14.25 12A2.25 2.25 0 0012 9.75z" />
    </svg>
);
...
export const PaletteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.098 19.902a3.75 3.75 0 005.304 0l1.414-1.414M4.098 19.902L2.25 21.75M8.625 15.375l1.414-1.414a3.75 3.75 0 015.304 0l1.414 1.414M8.625 15.375L6.75 17.25m8.25-1.125l1.414 1.414a3.75 3.75 0 005.304 0l1.414-1.414M16.875 14.25l-1.414 1.414m-1.414-1.414l1.414-1.414m-1.414 1.414l-1.414 1.414M12 21.75l1.414-1.414a3.75 3.75 0 000-5.304L12 13.625m-1.414 1.414l-1.414-1.414a3.75 3.75 0 010-5.304l1.414-1.414M10.586 12.21l-1.414 1.414M4.93 4.93l1.414 1.414a3.75 3.75 0 015.304 0l1.414 1.414M4.93 4.93L3 6.86m1.93-1.93l1.414-1.414" />
    </svg>
);
